...
* [.gitignore Isn’t the Only Way To Ignore Files in Git \| Nelson Figueroa](https://nelson.cloud/.gitignore-isnt-the-only-way-to-ignore-files-in-git/)
* [Improve diff generation with diff.algorithm=histogram - Adam Johnson](https://adamj.eu/tech/2024/01/18/git-improve-diff-histogram/)
